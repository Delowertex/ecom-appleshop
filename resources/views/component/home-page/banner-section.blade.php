...
async function BannerSlider() {
    ...
    res.data['data'].forEach((item, i)=>{
        ...
        let SliderItem = `<div class="carousel-item background_bg !important ${activeClass}" style="background-image: url('${item['image']}'); height='150px'">
                <div class="banner_slide_content">
                    <div class="container"><!-- STRART CONTAINER -->
                        <div class="row">
                            <div class="col-lg-7 col-9">
                                <div class="banner_content overflow-hidden">
                                	<h5 class="mb-3 staggered-animation font-weight-light" data-animation="slideInLeft" data-animation-delay="0.5s">${item['short_des']}</h5>
            ...
            $('#product-slider').append(SliderItem);
    })
}
</script>