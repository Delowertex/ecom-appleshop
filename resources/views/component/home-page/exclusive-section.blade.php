...
<script>
    async function Arrival() {
        ...
        let arrivalItem = 
        `<div class="row shop_container">
                <div class="col-lg-3 col-md-4 col-6"><div class="product">
                    <div class="product_img">
                        <a href="shop-product-detail.html">
        ...
        $('#arrival').append(arrivalItem);  
        });         
    }


    async function Featured(params) {
        let res = await axios.get("/ListProductByRemark/Featured");
        $('#featured').empty();
        res.data['data'].forEach((item, i)=>{
            let FeaturedItem = `<div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="${item['image']}" alt="product_img5">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
