        	...
        	<div class="col-12">
                ...
                <div class="tab-content">
                	<div class="tab-pane fade show active" id="arrival" role="tabpanel" aria-labelledby="arrival-tab">
                        <div class="row shop_container" id="arrivalItem">
                    ...
                    <div class="tab-pane fade" id="sellers" role="tabpanel" aria-labelledby="sellers-tab">
                        <div class="row shop_container" id="sellersItem">
                            {{-- <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                    ...
                    <div class="tab-pane fade" id="featured" role="tabpanel" aria-labelledby="featured-tab">
                        <div class="row shop_container" id="featuredItem">
                            {{-- <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
...
<script>
    async function arrival() {
        let res = await axios.get("/ListProductByRemark/newarival");
        $('#arrivalItem').empty();
        res.data['data'].forEach((item, i)=>{
            let EatchItem = `<div class="col-lg-3 col-md-4 col-6">
                    <div class="product">
                        <div class="product_img">
                            <a href="shop-product-detail.html">
            ...
            $("#arrivalItem").append(EatchItem);    
        })
    }

    async function bestseller() {
        let res = await axios.get("/ListProductByRemark/bestseller");
        $('#sellersItem').empty();
        res.data['data'].forEach((item, i)=>{
            let ItemSellers = `<div class="col-lg-3 col-md-4 col-6">
                    <div class="product">
                        <div class="product_img">
                            <a href="shop-product-detail.html">
                                <img src="${item['image']}" alt="product_img1">
            ...
            $("#sellersItem").append(ItemSellers);    
        })
    }

    async function featured() {
        let res = await axios.get("/ListProductByRemark/Featured");
        $('#featuredItem').empty();
        res.data['data'].forEach((item, i)=>{
            let ItemFeatured = `<div class="col-lg-3 col-md-4 col-6">
                    <div class="product">
                        <div class="product_img">
                            <a href="shop-product-detail.html">
                                <img src="${item['image']}" alt="product_img1">
            ...
            $("#featuredItem").append(ItemFeatured);    
        })
    }

    async function specialoffer() {
        let res = await axios.get("/ListProductByRemark/specialoffer");
        $('#specialItem').empty();
        res.data['data'].forEach((item, i)=>{
