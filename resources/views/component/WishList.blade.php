            ...
            <div class="col-lg-3 col-md-4 col-6">
                <div class="product">
                    <div class="product_img">
                        <a href="#">
                            <img src="images/shop_banner_img3.jpg" alt="product_img9">
                        </a>
                    ...
                    <div class="product_info">
                        <h6 class="product_title"><a href="#">Darrel Summey</a></h6>
                        ...
                        <button on class="btn remove btn-sm my-2 btn-danger" data-id="#">Remove</button>
